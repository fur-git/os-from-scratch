...
char toAscii(unsigned char code) {
    ...
    switch (code) {
        ...
        case 0x0C: parsed = '-'; break;
        case 0x0D: parsed = '='; break;
        case 0x0E: parsed = '~'; break;
        case 0x10: parsed = 'Q'; break;
        ...
        case 0x1A: parsed = '['; break;
        case 0x1B: parsed = ']'; break;
        case 0x1C: parsed = '!'; break;
        case 0x1E: parsed = 'A'; break;
        case 0x1F: parsed = 'S'; break;
        case 0x20: parsed = 'D'; break;
        case 0x21: parsed = 'F'; break;
        case 0x22: parsed = 'G'; break;
        case 0x23: parsed = 'H'; break;
        case 0x24: parsed = 'J'; break;
        case 0x25: parsed = 'K'; break;
        case 0x26: parsed = 'L'; break;
        case 0x27: parsed = ';'; break;
        case 0x28: parsed = '\''; break;
        case 0x29: parsed = '`'; break;
        case 0x2B: parsed = '\\'; break;
        case 0x2C: parsed = 'Z'; break;
        case 0x2D: parsed = 'X'; break;
        case 0x2E: parsed = 'C'; break;
        case 0x2F: parsed = 'V'; break;
        case 0x30: parsed = 'B'; break;
        case 0x31: parsed = 'N'; break;
        case 0x32: parsed = 'M'; break;
        case 0x33: parsed = ','; break;
        case 0x34: parsed = '.'; break;
        case 0x35: parsed = '/'; break;
